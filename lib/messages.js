...
let logHelp = () => {
    ...
    console.log(formatTextHeader('description'));
    console.log(formatTextParagraph(`${packageJson.description}`));

    console.log(formatTextHeader('synopsis'));
    console.log(formatTableRow(`${chalk['bold'](packageJson.name)} [ ${chalk['bold']('--install')} | ${chalk['bold']('--uninstall')} ] [${chalk['bold']('--key')} ${chalk['underline']('key')}] ${chalk['underline']('url')}`));

    console.log(formatTextHeader('options'));
    console.log(formatTableRow(`${chalk['underline']('url')}`, `URL to shorten`));
    console.log(formatTableRow(`${chalk['bold']('--key')} ${chalk['underline']('key')}`, `Override goo.gl API key`));
